...
export USER_ADDRESS=http://lab_05_user:8080
export POST_ADDRESS=http://lab_05_post:8080
export MESSAGE_ADDRESS=http://lab_05_message:8080

/app/build/lab_05_gateway