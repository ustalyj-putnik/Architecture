...
mongoimport --uri 'mongodb://lab05_mongo:27017/arch' --collection posts --file import_json/PostsJson.json --jsonArray
mongoimport --uri 'mongodb://lab05_mongo:27017/arch' --collection messages --file import_json/MessagesJson.json --jsonArray
