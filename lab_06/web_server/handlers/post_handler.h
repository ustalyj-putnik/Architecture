...
public:
                       ...
                       HTTPServerResponse &response)
    {
        ...
        {   
            ...
            {
                //long id = atol(form.get("author_id").c_str());
                auto results = database::Post::read_by_author_id(id);
                Poco::JSON::Array arr;
                for (auto s : results)
                    arr.add(s.toJSON());
            ...
            else if (request.getMethod() == Poco::Net::HTTPRequest::HTTP_POST)
            {
                ...
                post.author_id() = atol(form.get("author_id").c_str());
                post.post_datetime() = form.get("post_datetime");

                post.comment().comment_text = form.get("comment_text");
                post.comment().comment_author_id = atol(form.get("comment_author_id").c_str());
                post.comment().comment_datetime = form.get("comment_datetime");
